...
<ul id="menu" class="nav nav-pills nav-stacked nav-bracket">
	...
	<sec:authorize access="hasAnyRole('ADMINISTRATOR', 'SHARE')">
	...
	<sec:authorize access="hasAnyRole('ADMINISTRATOR', 'BASE')">
	...
	<sec:authorize access="hasAnyRole('ADMINISTRATOR', 'SYSTEM')">
	...
	$.ajax({
		...
		success : function(data) {
			if (data && data.t) {
				...
				setTimeout(function(){findTaskCount();}, 5000);
			}
		}
	});
}
