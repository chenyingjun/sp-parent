...
public class DateUtils {
    ...
    public static Date fomatDate(String date) {
        ...
        try {
            ...
            LoggerUtils.error(DateUtils.class, "时间格式化失败", e);
            return null;
        }
    }
    ...
    public static boolean isValidDate(String s) {
        ...
        try {
            ...
            LoggerUtils.error(DateUtils.class, "校验日期是否合法失败", e);
            return false;
        }
    }
    ...
    public static int getDiffYear(String startTime, String endTime) {
        ...
        try {
            ...
            LoggerUtils.error(DateUtils.class, "失败", e);
            // 如果throw java.text.ParseException或者NullPointerException，就说明格式不对
            return 0;
        }
    }
    ...
    public static long getDaySub(String beginDateStr, String endDateStr) {
        ...
        try {
            ...
            LoggerUtils.error(DateUtils.class, "时间相减得到天数失败", e);
        }
    ...
    public static Date parseToDate(String dateString) throws ParseException {
        ...
        if (dateString.matches(RegexStringsUtils.REG_FULL_DATE)) {
            return fullDateFormat.parse(dateString);
        } else if (dateString.matches(RegexStringsUtils.REG_DATE)) {
            return dateFormat.parse(dateString);
        } else if (dateString.matches(RegexStringsUtils.REG_PART_DATE)) {
            return partDateFormat.parse(dateString);
        } else if (dateString.matches(RegexStringsUtils.REG_RULE_FULL_DATE)) {
            return fullRullDateFormat.parse(dateString);
        } else if (dateString.matches(RegexStringsUtils.REG_RULE_DATE)) {
            return dateRullFormat.parse(dateString);
        } else if (dateString.matches(RegexStringsUtils.REG_RULE_PART_DATE)) {
    ...
    public static String getTimeBetweenDate(String start_time, String end_time) {
        try {
            ...
            LoggerUtils.error(DateUtils.class, "获取日期间的间隔 XX天XX小时XX分失败", e);
            return "";
        }
    }
